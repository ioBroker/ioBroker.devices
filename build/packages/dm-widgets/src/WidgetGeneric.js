...
exports.WidgetGeneric = void 0;
exports.isNeumorphicTheme = isNeumorphicTheme;
exports.getTileStyles = getTileStyles;
const react_1 = require("react");
// ---------------------------------------------------------------------------
// Helper functions
// ---------------------------------------------------------------------------
/** Check if the current theme is the neumorphic "styling-grey" preset */
function isNeumorphicTheme(theme) {
    return theme.wmPreset === 'styling-grey';
}
/** Returns tile background, border, border-radius, and transition styles */
function getTileStyles(_theme, _isActive, _accentColor, _interactive, _inactiveColor) {
...
// Base class
// ---------------------------------------------------------------------------
class WidgetGeneric extends react_1.Component {
...
exports.WidgetGeneric = WidgetGeneric;
exports.default = WidgetGeneric;
