...
export { WidgetButtonSensor } from './ButtonSensor';
export { WidgetCamera } from './Camera';
export { WidgetClock, type WidgetClockSettings } from './Clock';
export { WidgetCoAlarm } from './CoAlarm';
...
export { WidgetVacuumCleaner } from './VacuumCleaner';
export { WidgetPresence, type WidgetPresenceSettings } from './Presence';
export { WidgetPressure } from './Pressure';
